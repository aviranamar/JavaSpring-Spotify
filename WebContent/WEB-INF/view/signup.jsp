...
<ul class="topnav">
  ...
  <li><a href="changeDetail" onclick="return false;">Change Detail</a></li>
  <li><a href="songslist" onclick="return false;">Songs List</a></li>
  <li><a href="mysongs" onclick="return false;">My Songs</a></li>
  <li><a href="exit" onclick="return false;">Exit</a></li>
</ul>
...
<div class="container">
  <form:form action="checkLogin" modelAttribute="user">
    <div class="row">
      <div class="col-25">
        <label for="hellouser">User: Guest</label>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
